...
class PaymentService
{
    ...
    public function __construct(
        ...
        if (empty($stripeSecretKey)) {
            throw new \RuntimeException('La clé secrète Stripe n\'est pas configurée. Vérifiez vos variables d\'environnement.');
        }
        
        if (empty($stripeWebhookSecret)) {
            throw new \RuntimeException('Le secret du webhook Stripe n\'est pas configuré. Vérifiez vos variables d\'environnement.');
        }
